# =============================================================================
# Ethiopia Guild-specific ATT

# : PSM + WLS
# : PSM

# Ethiopia: bio3_trend, bio4_trend, bio7_trend, bio9_trend, bio13_trend, bio19_trend


#   - guild richness(S0, S3) × 3 guilds
#   - Ethiopiashapefile (adm3)
#   - PSM 1:1 matched data
#   - 


#   - Ethiopia_guild_richness_by_admin.csv
#   - Ethiopia_guild_DR_ATT_results.csv
#   - Ethiopia_matched_with_guild_richness.csv
# =============================================================================
...
cat("\n")
cat("╔══════════════════════════════════════════════════════════════════════╗\n")
cat("║     Ethiopia Guild-specific ATT                          ║\n")
cat("║     : PSM + WLS (Δbio3,4,7,9,13,19)                        ║\n")
cat("╚══════════════════════════════════════════════════════════════════════╝\n\n")
...
guild_raster_dir <- "D:/OneDrive - University of Leeds/biodiversity_manscript/results/Ethiopia/guild_richness"
admin_shp <- "E:/11.17progress/study_area/ETH_adm3.shp"
psm_file <- "E:/2026.1.8_biomod2/ethiopia_results/doubly_robust_50threshold/Ethiopia_1to1_matched_data_50threshold.csv"
climate_file <- "E:/2026.1.8_biomod2/ethiopia_results/climate_trends/Ethiopia_PSM_with_climate_trends.csv"


output_dir <- "D:/OneDrive - University of Leeds/biodiversity_manscript/results/Ethiopia/guild_richness"
...
guild_admin_file <- file.path(output_dir, "Ethiopia_guild_richness_by_admin.csv")
...
att_file <- file.path(output_dir, "Ethiopia_guild_DR_ATT_results.csv")
write.csv(att_results, att_file, row.names = FALSE)
cat(sprintf("  ✓ %s\n", att_file))


balance_climate$Country <- COUNTRY
balance_file <- file.path(output_dir, "Ethiopia_guild_climate_balance.csv")
write.csv(balance_climate, balance_file, row.names = FALSE)
cat(sprintf("  ✓ %s\n", balance_file))


matched_guild_file <- file.path(output_dir, "Ethiopia_matched_with_guild_richness.csv")
